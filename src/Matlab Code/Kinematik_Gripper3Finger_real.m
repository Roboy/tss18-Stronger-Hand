...
%     
%     n=i*(pi/180);
%     configzylindircalPower=[(posinitial+n/3);2*n; 3.5*n;(posinitial+n/3);2*n;3.5*n;(posinitial+n/3);2*n;3.5*n];
...
for i = 0:15:30
    ...
    n=i*(pi/180);
    configzylindircalPower=[posinitial+n/3;pi/8; pi/4;posinitial+n/3;pi/8;pi/4;posinitial+n/3;pi/8; pi/4];
    show(gripper,configzylindircalPower);
    hold on;
